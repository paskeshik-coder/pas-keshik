/*
 * Telegram Mini Apps script, vendored unmodified (only this comment added).
 * Source: https://telegram.org/js/telegram-web-app.js
 * Downloaded: 2026-09-23 (the file carries no release number; its built-in
 * default Bot API version is '6.0' and the real version is reported by the
 * Telegram client at run time).
 * SHA-256 of the downloaded file (without this comment):
 *   3549138a7934039fe7dfd1291a4ee739bd2b705a614308053a8b08a87d85c451
 * Self-hosted because public CDNs are unreachable from Iran.
 */
// WebView
(function () {
  var eventHandlers = {};
